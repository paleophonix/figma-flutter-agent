...
def test_shrink_wrap_scroll_host_omits_expanded_scroll_body() -> None:
    """Columns inside scroll hosts must not nest ``Expanded(SingleChildScrollView(...))``."""
    ...
    assert "Expanded(child: SingleChildScrollView" not in body
    assert "mainAxisSize: MainAxisSize.min" in body
