...
def test_oversized_delegate_honors_responsive_disabled() -> None:
    """Static mode must not inject GeneratedScreenShell on layout delegation."""
    padding = "x" * (_LARGE_PLANNED_DART_BYTES + 100)
    screen_path = "lib/features/background/background_screen.dart"
    layout_path = "lib/generated/background_layout.dart"
    planned = {
    ...
    assert "return const BackgroundLayout();" in screen
