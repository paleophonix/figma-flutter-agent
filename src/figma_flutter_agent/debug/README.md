...
Canonical paths and writers for `.figma_debug/raw/`, `.figma_debug/processed/`, `.figma_debug/ir/`, `.figma_debug/dart/`, and `.figma_debug/dart.bug/`. Filenames mirror generated layout/screen names.
