...
Prometheus ops metrics: `control_panel` `/metrics` (Bearer `CONTROL_PANEL_METRICS_TOKEN`) and ARQ worker `:9090/metrics`. See [docs/projects/26-06-18-observability/prometheus.md](../../../docs/projects/26-06-18-observability/prometheus.md).
