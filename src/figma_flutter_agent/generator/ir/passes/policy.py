...
def resolve_layout_pass_policy(
    ...
    """Return scroll fallback threshold and root scroll-host injection flag.

    Args:
        agent: Loaded agent YAML configuration.

    Returns:
        Tuple of ``(fallback_threshold_px, inject_root_scroll_host)``.
    """
    ...
    return threshold, passes.inject_root_scroll_host
