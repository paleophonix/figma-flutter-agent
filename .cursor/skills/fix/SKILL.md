...
name: fix
description: >-
  Implement fixes after /debug triage: control panel, infra, runtime imports,
...
Allowed: generic control-panel code, import-cycle breaks, env validation, worker/bot
...
| Domain | Fixes | Proof |
| ------ | ----- | ----- |
| **A. Control panel** | handlers, jobs, worker, config | `pytest tests/control_panel/…` |
