...
4. **Write the file** to `docs/projects/YY-MM-DD-<slug>.md` (or into `docs/projects/YY-MM-DD-<slug>/` if the project will have multiple files) — do not only paste in chat.
5. Report the file path and checklist summary. Stop — wait for user confirmation before S6 (`/work`).
...
- **Checklist is authoritative:** S6 (`/work`) executes checklist items in order and marks them done in this file.
