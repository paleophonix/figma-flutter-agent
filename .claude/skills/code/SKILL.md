...
**Allowed:** Analyzing relevant parts of the project (Glob, Grep, Read, Explore agent), identifying affected modules.
...
2. Search and read relevant project areas (Glob, Grep, Read, or Explore agent for broad searches).
