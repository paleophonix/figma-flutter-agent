...
**Allowed:** Using WebSearch (and WebFetch when a source URL is known) to look up libraries and patterns.
...
2. Run targeted WebSearch (and WebFetch when a source URL is known) for libraries, patterns, and established approaches relevant to the task.
